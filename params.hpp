...
namespace params
{
    ...
    namespace eigenFace
    {
        ...
        const int numComponents = 3; // Setting this to 0 means the algorithm will automatically pick c-1 // FIXME: WHY IS THIS STILL CRASHING!!?? // Still crash with 8 and 5 and 4 and 3 and 2. Only 1 works. WHY??? I get "killed" message. HUH??!?? Even TRAINING data is failing!!
//        const double threshold = 10.0;
