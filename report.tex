...
\subsection{Local Binary Patterns}
The LBP descriptor describes a pixel as an $P$-bit binary number based on the values of $P$ points in the circular neighbourhood of radius $R$ centred at the pixel. This number becomes its label.
...
Let $(P, R)$ denote the pixel neighbourhood of $P$ evenly-spaced points on a circle of radius $R$.
