...
After the parameters were optimised, all faces were successfully detected almost instantly.
...
The results of the K-means algorithm are used to generate histogram, $H_i$, with $K$ bins. We equalise $H_i$ to get $c_i$.
