...
OpenCV provides several trained XML files for face detection with Haar. I found that haarcascade\_frontalface\_alt2.xml provided the best results as others such as haarcascade\_frontalface\_default.xml failed to detect some of the faces. The XML file was generated via a tree-based 20*20 gentle adaboost frontal face detector. \hl{FIXME: Describe what the hell that means}
